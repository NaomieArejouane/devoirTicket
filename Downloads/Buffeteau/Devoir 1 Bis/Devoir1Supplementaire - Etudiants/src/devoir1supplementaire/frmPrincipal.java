...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnNbAnneesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnNbAnneesMouseClicked
        ...
        while (Total <= PrixCoutant)
        {
            Total = Total + PremAnnee;
            PremAnnee = PremAnnee * Pourcentage;
            
            AnneeSuiv++;
        }
        lblNbSemaines.setText(AnneeSuiv + " Annees ");
        // A vous de jouer
    ...
    private void btnTriangleMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTriangleMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this, "Veuillez saisir un nombre de ligne!");
        }
         int nb;
         DefaultTableModel.btnTriangle=(DefaultTableModel)tblTriangle;getModel();
         Vector v;
         v = new Vector();
         v.add("");
         btnTriangle.addRow(v);
    ...
    private void btnCalculerPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalculerPrimeMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this, "Veuillez saisir un nombre de bugs corriges");
        }
         else if(txtNbAnnees.getText().compareTo("")==0)
         {
            JOptionPane.showMessageDialog(this, "Veuillez saisir un nombre d'annees");
         }
         String txtNbAnnee = txtNbAnnees.getText();
        int intAncien = Integer.parseInt(txtNbAnnee);
        
        String txtBugs = txtNbBugs.getText();
        int intBugsC = Integer.parseInt(txtBugs);
        
        double Ancien = intAncien;
        double BugsC = intBugsC;
        
        if (Resultat > MaxPrime){
            lblPrime.setText("Prime" + MaxPrime + "euros");
        }
        else{
            if (Ancien > 4){
                Annee = Ancien - 4;
                PrimeAnciennete = Annee * 30 + PrimeAnciennete;
            }
            Resultat = BugsC * PrimeRend;
            Resultat = PrimeAnciennete + Resultat;
            lblPrime.setText("Prime :" + Resultat + "euros.");
        }
        // A vous de jouer
...
// variables exercice n°1:
        double PrixCoutant = 150;
        double Pourcentage = 0.8;
        double PremAnnee = 31;
        double AnneeSuiv = 0;
        double Total = 0;
 // variables exercice n°3:      
        double PrimeRend = 0.04;
        double MaxPrime = 400;
        double Resultat = 0;
        double Annee;
        double PrimeAnciennete = 300;
